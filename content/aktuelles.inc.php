...
<table style="border: none;" cellspacing="0" cellpadding="0" width="100%">
  <tr>
    <td style="vertical-align: top;">
      <p><b>Samstag, 23. November 2019: <a href="http://www.l-p-d.org/">Linux Presentation Day</a></b><br/>
        <b>10:30 bis 13:30 Uhr</b> in den R&auml;umen
        der <a href="https://www.openstreetmap.org/#map=19/48.52242/9.05565"><b>Stadtb&uuml;cherei T&uuml;bingen</b> (Nonnengasse 19)</a>.
        <br/>(<a href="http://www.tuebingen.de/stadtbuecherei">Link
          auf der Stadtb&uuml;cherei-Seite</a>)</p>
      <p>Der offizielle Linux Presentation Day ist eine Woche fr&uuml;her!
        Siehe <a href="http://www.l-p-d.org/">Linux Presentation Day</a> und
        <a href="http://www.linux-presentation-day.de/">(alte Webseite)</a>
      </p>
      <p>Den Besuchern werden auf dem Linux Presentation Day verschiedene
        Linux-Systeme pr&auml;sentiert. Diese k&ouml;nnen sie gleich vor Ort
        ausprobieren. Erfahrene Anwender der Linux User Group T&uuml;bingen
        und Reutlingen geben erste Orientierung und beantworten typische
        Fragen rund um das alternative Betriebssystem, wie nach dem Bezug,
        der Software, der Sicherheit oder m&ouml;glicher
        Unterst&uuml;tzung.
      </p>
      <p>Um ca. 11h gibt es einen Einf&uuml;hrungsvortag</p>
      <p>Wir haben ein Faltblatt vorbereitet, welches
        <a href="https://gitlab.com/erwaelde/linux-presentation-day-flyer-de/blob/master/LPD-Linux-Intro.pdf">hier</a>
        verf&uuml;gbar ist.
      </p>
      <p>L&auml;ngst ist Linux kein System mehr ausschlie&szlig;lich f&uuml;r
        IT-Profis, sondern l&auml;sst sich ebenso leicht wie Windows
        installieren und bringt dar&uuml;ber hinaus noch Software f&uuml;r
        viele Anwendungsbereiche und Benutzergruppen mit.
      </p>
      <p>Kinder und Jugendliche k&ouml;nnen mit Linux ihre ersten,
        lehrreichen Schritte am Computer mit Linux machen und dabei mit
        Spa&szlig; Rechnen und Lesen uvm. lernen.</p> 
      <p>Jugendlichen, Auszubildenden und Studierenden bietet das System
        viele Unterst&uuml;tzungsm&ouml;glichkeiten wie vorinstalliertes
        Officepaket, Kommunikation via eMail, Chat und Browser. Allgemein an
        Computerthemen Interessierte k&ouml;nnen unter Linux eine
        gro&szlig;e Anzahl von Programmiersprachen ausprobieren und sich an
        der Entwicklung von Linux und einzelner Programme beteiligen.</p>

    </td>
    
    <td style="vertical-align: top;" width="75px">&nbsp;</td>
